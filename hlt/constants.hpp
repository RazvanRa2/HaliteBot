...
namespace hlt {
    namespace constants {
        ...
        // "+ SHIP_RADIUS" takes into account rounding errors and the fact that
        // used algorithms are for objects without surface, thus extending the
        // "danger zone" for collision
        constexpr double FORECAST_FUDGE_FACTOR = 3 * SHIP_RADIUS;
        // 360 -> Tries to find available course in any direction
        constexpr int MAX_NAVIGATION_CORRECTIONS = 360;
